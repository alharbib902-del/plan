...
/**
 * Branded Arabic 404 for the client portal. Contextual back-link
 * returns to the client home (/me) instead of the public site, so
 * a signed-in client stays inside their dashboard. Server
    ...
    <div className="flex min-h-[60vh] items-center justify-center px-4 py-16">
      <div className="w-full max-w-md rounded-2xl border border-gold/30 bg-navy-card/60 p-8 text-center shadow-luxury">
        ...
        <p className="font-ar mt-3 text-sm leading-7 text-ink-secondary">
          قد يكون الرابط قديمًا أو غير صحيح. عُد إلى حسابك لمتابعة إدارة رحلاتك
          وطلباتك.
        </p>
        <Link
          href="/me"
