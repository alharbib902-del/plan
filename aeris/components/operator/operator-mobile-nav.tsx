...
/**
 * Mobile disclosure nav for the operator portal. The shell is a
 * Server Component that builds the feature-flag-filtered link
 * array; this client child only owns the open/close UI so the
 * portal stays navigable below the sm breakpoint where the inline
 * <nav> is hidden. Mirrors the public SiteHeader drawer pattern
 * (40x40 hamburger, aria-expanded, Escape-to-close).
 */
