...
export const operatorsAr = {
  ...
  portal: {
    ...
    crew: {
      title: 'إدارة الطواقم',
      subtitle: 'أضف أعضاء الطاقم وحدّث بياناتهم وحالة توفّرهم.',
      empty: 'لا يوجد أعضاء طاقم بعد. أضف أول عضو لتبدأ.',
      addCrew: 'إضافة عضو طاقم',
      addTitle: 'عضو طاقم جديد',
      editTitle: 'تعديل العضو',
      cancel: 'إلغاء',
      save: 'حفظ',
      saving: 'جارٍ الحفظ...',
      edit: 'تعديل',
      createdSuccess: 'تمت إضافة العضو.',
      updatedSuccess: 'تم تحديث بيانات العضو.',
      markAvailable: 'إتاحة',
      markUnavailable: 'إيقاف الإتاحة',
      updating: 'جارٍ...',
      labels: {
        full_name: 'الاسم الكامل',
        role: 'الدور',
        nationality: 'الجنسية (اختياري)',
        languages: 'اللغات (افصل بفواصل)',
        specializations: 'التخصّصات (افصل بفواصل، اختياري)',
        experience_hours: 'ساعات الخبرة (اختياري)',
        license_number: 'رقم الرخصة (اختياري)',
        license_expiry: 'انتهاء الرخصة (اختياري)',
        extra_fee: 'رسوم إضافية (ريال، اختياري)',
      },
      roles: {
        captain: 'قائد طائرة',
        first_officer: 'مساعد طيار',
        flight_attendant: 'مضيف/ة',
      },
      availability: {
        available: 'متاح',
    ...
    errors: {
      ...
      crew_not_found_or_not_owned: 'عضو الطاقم غير موجود أو لا يخصّ حسابك.',
      full_name_required: 'الاسم الكامل مطلوب.',
      full_name_too_long: 'الاسم الكامل طويل جداً.',
      role_invalid: 'الدور غير صالح.',
      extra_fee_invalid: 'الرسوم الإضافية غير صالحة.',
      experience_hours_invalid: 'ساعات الخبرة غير صالحة.',
      availability_invalid: 'قيمة التوفّر غير صالحة.',
      invalid_field_format: 'صيغة غير صالحة في أحد الحقول.',
      unknown: 'حدث خطأ غير متوقّع. حاول مرة أخرى أو راجع السجلّ.',
    },
  },
} as const;
